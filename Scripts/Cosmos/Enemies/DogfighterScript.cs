...
public class DogfighterScript : MonoBehaviour
{
    ...
    public float followSpeed = 2f; // Speed at which the object follows the target
    public float rotateSpeed = 5f; // Speed at which the object rotates towards the target
