...
public class ConstantemScript : MonoBehaviour
{
    ...
    public IEnumerator damageShip(int dmg)
    {
        ...
        healthBarRed.fillAmount = health / 60f;
        ...
        if (health <= 0)
        {
            ...
            PlayerPrefs.SetString("Planet Completed", "Fortis Completed");
